...
const About: React.FC = () => {
  ...
  return (
    <div style={{ lineHeight: "20px" }}>
      ...
      <p className="ion-text-justify">
        <strong>
          Use of all solvers and systems is provided under the respective
          licenses; we refrain from taking any responsibility for any use that
          goes out of the scopes of such licenses.
        </strong>
      </p>
